  ...
  return (
    ...
    <div className="ef-header-section">
      ...
      <div className="ef-header-img">
            <img src="/images/Research/ElectronicsFree-soft-robots/Picture1.png" 
       ...
       <div className="ef-header-text">
        ...
        <h1>Distributed and embodied control of electronics-free soft robots</h1>
        </div>
            <p>
            ...
            <p>
                <strong>Modular Control Units with Responsive Materials</strong><br/>
            ...
            <p>
                <strong>Logical Evaluations for Complex Responses</strong><br/>
