...
const PneumaticActuators = () => {
  return (
    <div className="pa-overall-container">
        ...
        <div className="pa-header-section">
          ...
          <div className="pa-header-content">
            ...
            <p>
                ...
                55To address this limitation, we decompose soft actuator deformations into three fundamental motion units: 
          ...
          <div className="pa-header-image">
            <img src="/images/Research/PneumaticActuators/header1.png" 
